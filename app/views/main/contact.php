  ...
  <div class="contact-wrapper">
    <div class="contact-info">
      ...
      <ul class="contact-info-list">
        <li>
          <svg viewBox="0 0 512 512" class="contact-info-icon"><path d="M256 0C153.1 0 69.1 84.1 69.1 187c0 148.8 165.1 313.3 172.1 320.2c7.9 7.7 20.8 7.7 28.7 0c7-6.9 172.1-171.4 172.1-320.2C442.9 84.1 358.9 0 256 0zM256 280c-51.4 0-93-41.6-93-93s41.6-93 93-93s93 41.6 93 93S307.4 280 256 280z"/></svg>
          <div>
        ...
        <li>
          <svg viewBox="0 0 512 512" class="contact-info-icon"><path d="M493.4 376.2l-98.5-42.2c-15.1-6.5-32.4-2-42.1 11L306 405.6c-76.3-39-138.3-101-177.3-177.3l60.6-46.8c13-10 17.5-27.1 11-42.1l-42.2-98.5c-7.1-16.6-25.7-26-43.5-22.3L40.9 33.3c-18.4 3.7-32 19.8-32 38.6C8.9 307.1 204.9 503.1 439.9 503.1c18.8 0 34.9-13.6 38.6-32l14.7-73.7c3.7-17.8-5.7-36.4-22.3-43.5z"/></svg>
          <div>
            <strong>Téléphone</strong>
            <a href="tel:+33771772785">+33 7 71 77 27 85</a>
          </div>
        </li>
        <li>
          <svg viewBox="0 0 512 512" class="contact-info-icon"><path d="M464 64H48C21.5 64 0 85.5 0 112v288c0 26.5 21.5 48 48 48h416c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48zM48 112h416v33.2L256 288 48 145.2V112zm416 288H48V195.2l197.3 135.5c3.3 2.3 7.1 3.4 10.7 3.4s7.4-1.1 10.7-3.4L464 195.2V400z"/></svg>
          <div>
            <strong>Email</strong>
            <a href="mailto:contact@mytek-energies.fr">contact@mytek-energies.fr</a>
          </div>
        </li>
        <li>
          <svg viewBox="0 0 512 512" class="contact-info-icon"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 348c-3.9 5.3-11.4 6.5-16.8 2.6z"/></svg>
          <div>
    ...
    <div class="form-box">
      ...
      <form method="POST">
        ...
        <button type="submit" class="btn-submit">
          <svg viewBox="0 0 512 512" class="submit-icon"><path d="M498.1 5.6c10.1 7 15.4 19.1 13.5 31.2l-64 416c-1.5 9.7-7.4 18.2-16 23s-18.9 5.4-28 1.6L284 427.7l-68.5 74.1c-8.9 9.7-22.9 12.9-35.2 8.1S160 493.2 160 480V396.4c0-4 1.5-7.8 4.2-10.7L420.6 128.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L128.3 323.3c-2.9 2.7-6.7 4.3-10.7 4.3H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H96.3l351.5-243.5c10.3-7.1 24-7.1 34.3 0c5.3 3.7 10.1 8.8 16 15.6z"/></svg>
          Envoyer le message
        </button>
      </form>
    </div>
