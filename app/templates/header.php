...
<head>
    ...
    <link rel="preload" href="/assets/img/logo.webp" as="image" fetchprioity="high">
...
<body>
    <div class="topbar">
        <div class="topbar-left">
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="14" height="14" fill="currentColor" aria-hidden="true" style="margin-right: 5px; vertical-align: -2px;">
                    <path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/>
                </svg>
                67350 Niedermodern, France
            </span>
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="14" height="14" fill="currentColor" aria-hidden="true" style="margin-right: 5px; vertical-align: -2px;">
...
<a href="/" class="logo" title="Mytek Energies">
  <picture>
    ...
    <img src="/assets/img/logo.webp" 
         ...
         decoding="async">
            ...
            <button class="burger" aria-label="Menu" onclick="document.getElementById('mobile-nav').classList.toggle('open')">
        ...
        <nav class="mobile-nav" id="mobile-nav">
            ...
            <a href="/contact" class="btn-mobile">Contactez-nous</a>
        </nav>
    </header>
